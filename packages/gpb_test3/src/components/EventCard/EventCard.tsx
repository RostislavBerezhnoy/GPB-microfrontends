...
import { DATETIME_FORMAT } from 'helpers/date'
import { defaultDateRangeValue, EMPTY_TIME, validationSchema } from './helpers'
...
export const EventCard: FC<EventCardProps> = ({ event }) => {
  ...
  const onTimeChange = (time: Dayjs | null, formattedTime: string) => {
    if (time && formattedTime !== EMPTY_TIME) void setFieldValue('reminder', time.valueOf())
  }
